...
class BinaryAL:
    ...
    def dumb_plotter_rank(self, performance_measure, start_index, batch_size):
        ...
        plt.title('Rank based Active learning performance on binary classifier')
        plt.legend()
        plt.show()
...
al1 = BinaryAL(10, 120)
# al1.learnAndPlot()
al1.learnAndPlotRankBased(80, 3)


al2 = BinaryAL(10, 120)
# al1.learnAndPlot()
al2.learnAndPlotRankBased(80, 5)


al3 = BinaryAL(10, 120)
# al1.learnAndPlot()
al3.learnAndPlotRankBased(80, 7)


al4 = BinaryAL(10, 120)
# al1.learnAndPlot()
al4.learnAndPlotRankBased(80, 9)
