...
class BinaryAL:
    ...
    def dumb_plotter_proba(self, performance_measure, start_index, proba):
        ...
        plt.title('Query by committee strategy on binary case(' + str(proba) + '% wrong labeling' + ')')
        plt.legend()
        plt.show()
...
acc, pre, rec, fs = al1.learn_qbc_proba(RandomForestClassifier(), uncertainty_sampling, 5)
dic = {
    'accuracy': acc,
    'precision': pre,
    'recall': rec,
...
acc, pre, rec, fs = al2.learn_qbc_proba(RandomForestClassifier(), uncertainty_sampling, 10)
dic = {
    'accuracy': acc,
    'precision': pre,
    'recall': rec,
...
acc, pre, rec, fs = al3.learn_qbc_proba(RandomForestClassifier(), uncertainty_sampling, 15)
dic = {
    'accuracy': acc,
    'precision': pre,
    'recall': rec,
...
acc, pre, rec, fs = al4.learn_qbc_proba(RandomForestClassifier(), uncertainty_sampling, 20)
dic = {
    'accuracy': acc,
    'precision': pre,
    'recall': rec,
...
acc, pre, rec, fs = al5.learn_qbc_proba(RandomForestClassifier(), uncertainty_sampling, 25)
dic = {
    'accuracy': acc,
    'precision': pre,
    'recall': rec,
